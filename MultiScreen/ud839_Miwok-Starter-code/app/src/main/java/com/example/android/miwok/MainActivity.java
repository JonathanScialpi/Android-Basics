...
/*
    protected void goToNumbersActivity(View view){
        Intent i = new Intent(this, Numbers.class);
        startActivity(i);
    }
    protected void goToFamilyActivity(View view){
        Intent i = new Intent(this, Family.class);
        startActivity(i);
    }
    protected void goToColorsActivity(View view){
        Intent i = new Intent(this, Phrases.class);
        startActivity(i);
    }
    protected void goToPhrasesActivity(View view){
